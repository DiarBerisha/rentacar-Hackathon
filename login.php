...
<body>
    <form action="loginLogic.php" class="login" method="POST">
        <h2>Kyçu</h2>
        <p>Nese nuk kini nje llogari ne <a href="index.php">Rent A Car Diari</a> <a href="register.php">regjistrohuni</a>tani!</p>
        <input type="email" class="email-l" placeholder="Email" >
        <input type="password" class="password-l" placeholder="Fjalkalimi" >
        <p><a href="forgot-password.php">Kam harruar fjalkalimin!</a></p>
